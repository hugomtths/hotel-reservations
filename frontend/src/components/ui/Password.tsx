    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          id={name}
          name={name}
          className="block w-full p-2.5 pr-10 bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 outline-none transition-all"
          placeholder={message}
          value={value}
